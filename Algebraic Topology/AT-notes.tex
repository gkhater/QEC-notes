...
\end{theorem}
Where the rank of a finitely generated abelian group is the number of $\mathbb{Z}$ summands when the group is expressed as a direct sum of cyclic groups. 
Notice that if $0 \to A \to B \to C \to 0$ is a short exact sequence of finitely generated groups, then $\operatorname{rank} B = \operatorname{rank} A + \operatorname{rank} C$. 
