...
Conversely, assume that $X$ is a quotient of $\amalg_{j \in J} U_j$ such that each $h_i \colon U_i \to X$ 
...
\begin{definition}
  ...
  \begin{itemize}
    \item The canonical map $\amalg_{j \in J} X_j \to X$ (inclusion on each summand) is a quotient map. 
